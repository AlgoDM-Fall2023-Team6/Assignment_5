...
def Image_Search_by_Text():
    ...
    openai.api_key = "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"  # Replace with your actual OpenAI API key
    ...
    def search_similar_images(query):
        serpapi_key = "D5B91EA1C93F4946A79E4B97104C5D8F"  # Replace with your actual SerpApi key
        params = {
            "q": query,
